...
describe User do
  ...
  describe "authenticate method" do
    ...
    it "should return nil for nil email" do
      user = User.authenticate(nil, @attr[:password])
      user.should be_nil
    end
  ...
  describe "micropost associations" do
    ...
    it "should have the correct number of microposts" do
      @user.microposts.length.should == 2
    end
    ...
    describe "status feed" do
      ...
      it "should not include a different user's microposts" do
        mp3 = Factory(:micropost, :user => Factory(:user, :email => Factory.create(:email)))
